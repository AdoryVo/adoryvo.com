<template>
	<main>
		...
		<p>
			Hey! I'm <b class="text-blue-300">Adory</b>, an alum with a B.S. in
			Math &amp; Computer Science from <b class="text-blue">UC San Diego</b>
			pursuing a career in software development and potentially teaching.
			...
			(<NuxtLink class="link-primary" to="https://github.com/AdoryVo/adoryvo.com" target="_blank">Github Repository</NuxtLink>).
		</p>
		...
		<ul class="list-disc list-inside">
			...
			<li>Favorite video game franchises: Pokémon, Nintendo games, League of Legends</li>
			<li><i><NuxtLink class="link-primary" to="/music">Click here to judge my music taste</NuxtLink></i>
			</li>
		</ul>
	</main>
</template>
