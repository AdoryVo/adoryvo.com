...
<template>
	<main>
		<BodyTitle class="mb-0">freelancing</BodyTitle>
		<b class="text-green-400">Completed: June 2019 - February 2022</b>
		<p class="my-4">
			Projects completed for freelance clients on Fiverr & Upwork.
			<br>
			<i>- Done in partnership with Ryan Heo</i>
		</p>
